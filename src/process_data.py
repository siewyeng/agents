...
def main(args):
    ...
    for raw_data_subdir_name in raw_data_subdir_list:
        ...
        curr_train_dataset = smp.data_prep.datasets.MNISTDataset(
            curr_raw_data_subdir_path,
            "train.csv",
            to_tensor=False,
            transform=smp.data_prep.transforms.MNIST_TRANSFORM_STEPS["train"],
        )
        ...
        if "test.csv" in curr_dir_files:
            test_dataset = smp.data_prep.datasets.MNISTDataset(
                ...
                "test.csv",
                to_tensor=False,
                transform=smp.data_prep.transforms.MNIST_TRANSFORM_STEPS["test"],
            )
