...
=== "Linux/macOS"
    ...
    ```bash
    $ docker build \
        -t registry.aisingapore.net/aiap-14-dsp/stemss-mini-project/vscode-server-custom:0.1.0 \
        -f docker/vscode-server/vscode-server.Dockerfile \
        --platform linux/amd64 .
    $ docker push registry.aisingapore.net/aiap-14-dsp/stemss-mini-project/vscode-server-custom:0.1.0
    ```
...
=== "Linux/macOS"
    ...
    ```bash
    $ docker build \
        -t registry.aisingapore.net/aiap-14-dsp/stemss-mini-project/jupyterlab-server-custom:0.1.0 \
        -f docker/jupyterlab-server/jupyterlab-server.Dockerfile \
        --platform linux/amd64 .
    $ docker push registry.aisingapore.net/aiap-14-dsp/stemss-mini-project/jupyterlab-server-custom:0.1.0
    ```
