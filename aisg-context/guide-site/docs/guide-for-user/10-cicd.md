...
=== "`.gitlab-ci.yml`"
    ...
    test:pylint-pytest:
      ...
      before_script:
        - conda env create -f stemss-mini-project-conda-env.yaml
        - source activate stemss-mini-project
      script:
...
- `registry.aisingapore.net/aiap-14-dsp/stemss-mini-project/data-prep`
- `registry.aisingapore.net/aiap-14-dsp/stemss-mini-project/model-training`
    ...
    build:data-prep-image:
      ...
      script:
        ...
        - >-
          ...
          --dockerfile "${CI_PROJECT_DIR}/docker/stemss-mini-project-data-prep.Dockerfile"
          --destination "registry.aisingapore.net/aiap-14-dsp/stemss-mini-project/data-prep:${CI_COMMIT_SHORT_SHA}"
      rules:
        - if: $CI_MERGE_REQUEST_IID
          changes:
            - docker/stemss-mini-project-data-prep.Dockerfile
            - src/**/*
            - conf/**/*
...
=== "`.gitlab-ci.yml`"
    ...
    build:retag-images:
      ...
      script:
        ...
        - crane tag registry.aisingapore.net/aiap-14-dsp/stemss-mini-project/data-prep:${CI_COMMIT_SHORT_SHA} ${$CI_COMMIT_TAG}
        - crane tag registry.aisingapore.net/aiap-14-dsp/stemss-mini-project/model-training:${CI_COMMIT_SHORT_SHA} ${$CI_COMMIT_TAG}
      rules:
