...
=== "`.gitlab-ci.yml`"
    ...
    test:pylint-pytest:
      ...
      before_script:
        ...
        - source activate stems-mini-project
      script:
...
- `registry.aisingapore.net/aiap-14-dsp/stems-mini-project/data-prep`
- `registry.aisingapore.net/aiap-14-dsp/stems-mini-project/model-training`
    ...
    build:data-prep-image:
      ...
      script:
        ...
        - >-
          ...
          --dockerfile "${CI_PROJECT_DIR}/docker/stems-mini-project-data-prep.Dockerfile"
          --destination "registry.aisingapore.net/aiap-14-dsp/stems-mini-project/data-prep:${CI_COMMIT_SHORT_SHA}"
      rules:
        - if: $CI_MERGE_REQUEST_IID
          changes:
            - docker/stems-mini-project-data-prep.Dockerfile
            - src/**/*
            - conf/**/*
...
=== "`.gitlab-ci.yml`"
    ...
    build:retag-images:
      ...
      script:
        ...
        - crane tag registry.aisingapore.net/aiap-14-dsp/stems-mini-project/data-prep:${CI_COMMIT_SHORT_SHA} ${$CI_COMMIT_TAG}
        - crane tag registry.aisingapore.net/aiap-14-dsp/stems-mini-project/model-training:${CI_COMMIT_SHORT_SHA} ${$CI_COMMIT_TAG}
      rules:
