...
- First, have VSCode open the repository that you have cloned
  ...
  `/<NAME_OF_DATA_SOURCE>/workspaces/<YOUR_HYPHENATED_NAME>/stemss-mini-project`.
...
=== "VSCode Server Terminal"
    ...
    ```bash
    (base) $ conda env create -f stemss-mini-project-conda-env.yaml \
                -p /<NAME_OF_DATA_SOURCE>/workspaces/<YOUR_HYPHENATED_NAME>/conda_envs/stemss-mini-project-conda-env
    ```
...
=== "VSCode Server Terminal"
    ...
    ```bash
    (base) $ echo 'alias stemss-mini-project-conda-env="conda activate /<NAME_OF_DATA_SOURCE>/workspaces/<YOUR_HYPHENATED_NAME>/conda_envs/stemss-mini-project-conda-env"' >> ~/.bashrc
    (base) $ source ~/.bashrc
    (base) $ stemss-mini-project-conda-env
    (stemss-mini-project-conda-env) $ # conda environment has been activated
    ```
...
- Ensure that you have
  ...
  `stemss-mini-project-conda-env.yaml`. You can check for the
  library like so:

=== "VSCode Server Terminal"

    ```bash
    $ conda activate /<NAME_OF_DATA_SOURCE>/workspaces/<YOUR_HYPHENATED_NAME>/conda_envs/stemss-mini-project-conda-env
...
=== "JupyterLab Terminal"
    ...
    ```bash
    $ ipython kernel install --name "stemss-mini-project-conda-env" --user
    ```
